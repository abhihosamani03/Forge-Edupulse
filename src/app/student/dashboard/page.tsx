...
export default function StudentDashboard() {
  ...
  const nbaScore = calculateNbaScore(user.id);
  const verifiedAchievements = mockAchievements.filter((a) => a.student_id === user.id && a.status === "Verified");

  const pendingAchievements = mockAchievements.filter(
    (a) => a.student_id === user.id && a.status === "Pending"
  ).length;
