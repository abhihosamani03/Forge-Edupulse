...
export default function MentorSettings() {
  const [user, setUser] = useState(currentMentorUser);
  ...
  return (
    ...
    >
      <div className="mb-6">
        ...
        <p className="text-text-muted text-sm mt-0.5">Manage your faculty account preferences and profile</p>
      </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="card p-6">
            <div className="flex items-center gap-2 mb-4 border-b border-surface-border pb-4">
              ...
              <h2 className="font-heading font-bold text-text-primary text-lg">Professional Information</h2>
            </div>
            <form onSubmit={handleSaveProfile} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input type="text" disabled defaultValue={user.employee_id} className="input opacity-50 cursor-not-allowed" />
                </div>
                <div>
                ...
                <div>
                  ...
                  <input type="text" disabled defaultValue={user.designation} className="input opacity-50 cursor-not-allowed" />
                </div>
              </div>
        ...
        <div className="space-y-6">
          <div className="card p-6">
            ...
            <div className="space-y-4">
              ...
              <label className="flex items-center justify-between cursor-pointer">
                <span className="text-sm text-text-primary">Mentee Requests</span>
                <input type="checkbox" defaultChecked className="accent-accent w-4 h-4 cursor-pointer" />
              </label>
              <label className="flex items-center justify-between cursor-pointer">
                <span className="text-sm text-text-primary">Assignment Submissions</span>
